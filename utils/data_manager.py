...
def read_data(filename, data_type='preprocess', **kwargs):
    ...
    full_path, file_extension = get_path(filename, data_type)
    if file_extension.lower() == '.xlsx':
        return pd.read_excel(full_path, **kwargs)
    else:
        return pd.read_csv(full_path, **kwargs)
    
def write_data(filename, dataframe, **kwargs):
    full_path, _ = get_path(filename, 'preprocess')
